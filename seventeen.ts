...
let guestNames : string[] = ["Yousuf siyal,", "Aqib mahar", "Waqas Ali"];  
 //one person can't attend the dinner

let person_not_come2: string = guestNames[2];
